...
public class BeerWithRepositoryControllerTest {
    ...
    void getBeerById() throws Exception {
        given(beerRepository.findById(ArgumentMatchers.any())).willReturn(Optional.of(Beer.builder().build()));
        mockMvc.perform(RestDocumentationRequestBuilders.get("/api/v1/repository/beer/{beerId}", UUID.randomUUID().toString())
                .param("iscold", "yes")
                .accept(MediaType.APPLICATION_JSON))
                .andExpect(status().isOk())
                .andDo(MockMvcRestDocumentation.document("v1/beer-repository-get",
    ...
    void saveNewBeer() throws Exception {
        ...
        mockMvc.perform(RestDocumentationRequestBuilders.post("/api/v1/repository/beer/")
                .contentType(MediaType.APPLICATION_JSON)
                .content(beerDtoJson))
                .andExpect(status().isCreated())
                .andDo(MockMvcRestDocumentation.document("v1/beer-repository-post",
    ...
    void updateBeerById() throws Exception {
        ...
        mockMvc.perform(RestDocumentationRequestBuilders.put("/api/v1/repository/beer/" + UUID.randomUUID().toString())
                .contentType(MediaType.APPLICATION_JSON)
                .content(beerDtoJson))
